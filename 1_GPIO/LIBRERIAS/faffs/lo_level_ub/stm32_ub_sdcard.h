...
// TIM_Frq = 1kHz => 1ms
//--------------------------------------------------------------
#define   SD_1MS_TIM              TIM3
#define   SD_1MS_TIM_CLK          RCC_APB1Periph_TIM3
#define   SD_1MS_TIM_PERIODE      900 - 1
#define   SD_1MS_TIM_PRESCALE     40 - 1
#define   SD_1MS_TIM_IRQ          TIM3_IRQn
#define   SD_1MS_TIM_ISR_HANDLER  TIM3_IRQHandler
